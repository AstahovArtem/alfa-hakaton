...
var issuerStartWordRe = regexp.MustCompile(
	`(?i)(паспортным столом|межрайонным|отделением|отделении|отделения|отделом|отделе|отдел|управлением|управления|управление|миграционным|миграционной|паспортно-визовым|паспортным|паспортного|` +
		`генеральным консульством|генеральное консульство|консульством|консульство|консульства|` +
		`посольством|посольство|посольства|министерством внутренних дел|министерство внутренних дел|` +
		`гу мвд|гувм мвд|гувд|оуфмс|уфмс|фмс|омвд|умвд|увм|овм|увд|овд|мвд|милиции|о/м|тп|оп|мп)`,
)
...
var issuerStartWordLowerRe = regexp.MustCompile(
	`(паспортным столом|межрайонным|отделением|отделении|отделения|отделом|отделе|отдел|управлением|управления|управление|миграционным|миграционной|паспортно-визовым|паспортным|паспортного|` +
		`генеральным консульством|генеральное консульство|консульством|консульство|консульства|` +
		`посольством|посольство|посольства|министерством внутренних дел|министерство внутренних дел|` +
		`гу мвд|гувм мвд|гувд|оуфмс|уфмс|фмс|омвд|умвд|увм|овм|увд|овд|мвд|милиции|о/м|тп|оп|мп)`,
)
