...
| --- | --- |
| `full_name` | Иванов Иван Иванович, И. И. Иванов, латиница после «name:», нижний регистр после «клиент:», тюркские отчества кызы/оглы |
...
| `passport_issuer` | ОУФМС России по г. Москве, ТП № 71 отдела УФМС |
| `division_code` | 770-001 |
| `birth_place` | г. Тула, с. Большие Кайбицы Кайбицкого района |
| `citizenship` | Россия, Республика Беларусь, гражданин Узбекистана |
| `driver_license` | 77 12 345678, в/у 7712345678 |
| `foreign_passport` | AB1234567 при контексте загранпаспорта |
| `address` | индекс, город, улица, дом, квартира; полный адрес и отдельные компоненты с метками |
| `phone` | +7 916 123-45-67, 8 (4872) 36-01-22, международные +998 |
| `email` | ivanov@mail.ru |
| `inn` | 12 цифр физлица; 10-значный ИНН организации не маскируется |
| `snils` | 112-233-445 95, 11223344595 |
| `card_number` | 16-19 цифр с проверкой Луна |
| `cvv` | три цифры с меткой |
| `pin` | четыре цифры с меткой |
| `card_holder` | IVAN IVANOV на карте |
